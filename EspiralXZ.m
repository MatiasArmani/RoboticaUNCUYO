...
centro_x = 0.45;  % Centro de la espiral en el eje x
centro_z = 0.3;  % Centro de la espiral en el eje z
...
y = linspace(altura_inicial, altura_final, n_puntos);  % Coordenada y de la espiral
...
grid on;
axis equal;
title('Simulación de la trayectoria en espiral del robot con proyección en el plano xz');
